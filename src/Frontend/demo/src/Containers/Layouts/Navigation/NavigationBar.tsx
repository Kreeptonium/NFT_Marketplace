...
import {HamburgerTransition} from "./Parts/HamburgerTransition";
...
export default class NavigationBar extends Component<INavigationBarProps,INavigationBarState>{
                        ...
                        <div className="flex items-center h-20 px-4">
                            ...
                            <div className="hidden md:block w-full">
                                <div className="ml-10 flex items-baseline justify-end">
                                    <NavBarLink TextColor={"text-white font-bold"} Hover_TextColor={"hover:text-white"} Hover_BackgroundColor={"hover:bg-gray-700"}></NavBarLink>
                                </div>
                            </div>
                            {/* Mobile Menu */}
